  ...
  return [
      ...
      render: (value, record) => (
        <span>
          {record.invocation_count > 1 && (
            <Tag>
              {t('auto.task_invocation_count', {
                count: record.invocation_count
              })}
            </Tag>
          )}
    ...
    },
    {
      ...
      render: (value) => (
        <Tag>
          {executionStageLabel(
            value as ApplicationRunSummary['execution_stage'],
            t
          )}
        </Tag>
      )
      ...
      render: (value) => (
        <Tag>
          {invocationSourceLabel(
            value as ApplicationRunSummary['invocation_source'],
            t
          )}
        </Tag>
      )
    ...
    },
    {
      ...
      width: 160,
      render: (value) =>
        typeof value === 'string' && value ? value : t('auto.full_flow')
    },
    {
      key: 'status',
      title: t('auto.status'),
    ...
    },
    {
      ...
      width: 130,
      render: (_value, run) => formatRunStatisticRate(run.input_cache_hit_rate)
    },
    {
