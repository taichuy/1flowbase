alter table model_provider_request_logs
    add column cache_write_tokens bigint check (cache_write_tokens >= 0);
...
from (
    values
        ('00000000-1535-4000-8000-000000000040'::uuid, 'cache_write_tokens', 'Cache write tokens', 'number', false, false, 39)
