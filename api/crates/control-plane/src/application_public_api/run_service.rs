...
use control_plane_contracts::application_public_runtime::EMBEDDED_ASSISTANT_USER_MESSAGE_PAYLOAD_KEY;
pub use control_plane_contracts::application_public_runtime::{
    embedded_assistant_user_message, AssistantPageReference, AssistantUserMessage,
...
pub struct CreateAssistantRunCommand {
    ...
    pub page_references: Vec<AssistantPageReference>,
        ...
        + Clone,
{
    ...
    pub async fn create_assistant_run(
        &self,
        mut command: CreateAssistantRunCommand,
        ...
        input_payload
            ...
            .insert(
                EMBEDDED_ASSISTANT_USER_MESSAGE_PAYLOAD_KEY.to_string(),
