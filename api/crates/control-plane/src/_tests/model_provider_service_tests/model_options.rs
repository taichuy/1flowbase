        ...
        .create_instance(CreateModelProviderInstanceCommand {
            ...
            configured_models: vec![
                ModelProviderConfiguredModelInput {
                    ...
                    pricing_provider_code: " openai ".to_string(),
                    pricing_model_id: " gpt-price ".to_string(),
                },
                ModelProviderConfiguredModelInput {
                    ...
                    pricing_provider_code: String::new(),
        ...
        .update_instance(UpdateModelProviderInstanceCommand {
            ...
            configured_models: vec![
                ModelProviderConfiguredModelInput {
                    ...
                    context_window_override_tokens: Some(64_000),
                    supports_multimodal: None,
                    pricing_provider_code: "anthropic".to_string(),
                    pricing_model_id: "claude-price".to_string(),
                },
                ModelProviderConfiguredModelInput {
