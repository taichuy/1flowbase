...
fn push_model_provider_request_log_filters<'a>(
    ...
    if let Some(flow_run_id) = input.flow_run_id {
        query
            .push(" and logs.flow_run_id = ")
            .push_bind(flow_run_id);
    }
