...
use extension_package_runtime::{
    ...
    provider_contract::{
        ...
        ProviderCountTokensResult, ProviderGenerateTranslationReceipt,
        ProviderInvocationCapability, ProviderInvocationInput, ProviderInvocationResult,
        ProviderModelDescriptor, ProviderOperationalCapability, ProviderPhysicalTransportState,
        ...
        ProviderStreamEvent, ProviderTransportClosureEvidence, ProviderTransportClosureSource,
