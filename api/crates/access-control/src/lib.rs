...
pub use settings_features::{
    ...
    SYSTEM_AUTH_CENTER_SETTINGS_FEATURE_PERMISSION, SYSTEM_HOST_INFRASTRUCTURE_SETTINGS_FEATURE_ID,
    ...
    SYSTEM_MEMORY_OBSERVATION_SETTINGS_FEATURE_PERMISSION, SYSTEM_ROLES_SETTINGS_FEATURE_ID,
