...
#[openapi(
    paths(
        ...
        crate::routes::data_sources::get_main_source,
        ...
        crate::routes::data_sources::update_main_source_defaults,
    ...
    components(schemas(
        ...
        crate::routes::data_sources::MainDataSourceResponse,
        ...
        crate::routes::frontstage::SaveFrontstageTabDocumentPayloadBody,
