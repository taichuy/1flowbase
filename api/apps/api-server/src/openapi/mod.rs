...
#[openapi(
    paths(
        ...
        crate::routes::plugins::list_local_extension_inventory,
        crate::routes::plugins::list_extension_catalog_gateway,
        crate::routes::plugins::get_extension_catalog_entry,
        crate::routes::plugins::check_extension_catalog_page_updates,
        crate::routes::plugins::install_official_extension,
        crate::routes::plugins::update_official_extension,
        crate::routes::plugins::install_uploaded_extension,
    ...
    components(schemas(
        ...
        crate::routes::plugins::ExtensionRiskWarningResponse,
        crate::routes::plugins::LocalExtensionInventoryEntryResponse,
        crate::routes::plugins::LocalExtensionInventoryPageResponse,
        crate::routes::plugins::ExtensionCatalogGatewayEntryResponse,
        crate::routes::plugins::ExtensionCatalogGatewayPageResponse,
        crate::routes::plugins::ExtensionUpdateCheckBody,
        crate::routes::plugins::ExtensionUpdateCheckItemBody,
        crate::routes::plugins::ExtensionUpdateCheckItemResponse,
        crate::routes::plugins::ExtensionUpdateCheckResponse,
        crate::routes::plugins::InstallOfficialExtensionBody,
