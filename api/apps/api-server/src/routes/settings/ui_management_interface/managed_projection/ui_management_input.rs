...
impl InterfaceContract for UiManagementInput {
    fn managed_projection_schema() -> Option<serde_json::Value> {
        ...
        Some(mp::union_schema(vec![
            ...
            mp::object_schema(&[("variant", mp::tag_schema("ListTemplates"))]),
            mp::object_schema(&[
            ...
            mp::object_schema(&[
                ("variant", mp::tag_schema("DeleteTemplate")),
                ("id", mp::text_schema()),
            ]),
    ...
    fn project_for_managed_hook(&self) -> Option<serde_json::Value> {
        ...
        Some(match self {
            ...
            Self::ListTemplates => {
                mp::object_value(&[("variant", serde_json::json!("ListTemplates"))])
            }
            ...
            Self::DeleteTemplate { id } => mp::object_value(&[
                ("variant", serde_json::json!("DeleteTemplate")),
                ("id", mp::text(id)?),
            ]),
