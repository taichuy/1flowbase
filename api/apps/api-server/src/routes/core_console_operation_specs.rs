...
pub(crate) static CORE_CONSOLE_OPERATION_SPECS: &[CoreConsoleOperationSpec] = &[
    ...
    settings("i18n_catalog.entries.detail", "system.i18n-catalog"),
    settings("i18n_catalog.entries.list", "system.i18n-catalog"),
    settings("i18n_catalog.overrides.restore", "system.i18n-catalog"),
    settings("i18n_catalog.overrides.restore_all", "system.i18n-catalog"),
    settings("i18n_catalog.overrides.upsert", "system.i18n-catalog"),
    ...
    settings("extension_center.install", "system.extension-center"),
    settings("extension_center.install.upload", "system.extension-center"),
    settings("extension_center.update", "system.extension-center"),
    other("js_dependencies.view", "other.js-dependencies"),
    settings("mcp.bundle_library.current.switch", "system.mcp-management"),
    settings("mcp.bundle_library.import", "system.mcp-management"),
    settings("mcp.bundle_library.list", "system.mcp-management"),
    settings("mcp.bundle_library.preview", "system.mcp-management"),
    settings(
    ...
    settings("mcp.bundle_library.sync", "system.mcp-management"),
