...
pub(crate) static CORE_CONSOLE_OPERATION_SPECS: &[CoreConsoleOperationSpec] = &[
    ...
    settings("auth_center.login_entries.copy", "system.auth-center"),
    settings("auth_center.login_entries.create", "system.auth-center"),
    settings("auth_center.login_entries.delete", "system.auth-center"),
    settings(
        "auth_center.login_entries.enabled.update",
        "system.auth-center",
    ),
    settings("auth_center.login_entries.order", "system.auth-center"),
    settings("auth_center.login_entries.update", "system.auth-center"),
    ...
    settings("billing.pricing_rules.list", "system.model-providers"),
    settings("billing.pricing_rules.create", "system.model-providers"),
    settings("billing.pricing_rules.update", "system.model-providers"),
    ...
    settings("billing.credit.grant", "system.members"),
    settings("billing.credit.charge", "system.members"),
    settings("billing.credit.adjust", "system.members"),
    settings("billing.credit.enable", "system.members"),
    settings("billing.credit.disable", "system.members"),
    settings("billing.credit.refund", "system.members"),
    ...
    settings("ui_management.components.create", "system.ui-management"),
    settings("ui_management.components.delete", "system.ui-management"),
    ...
    settings("network_egress_routes.delete", "system.network-center"),
    settings("network_egress_routes.list", "system.network-center"),
    settings("network_egress_routes.update", "system.network-center"),
    ...
    settings("system_templates.catalog", "system.backups"),
    settings("system_templates.export", "system.backups"),
    settings("system_templates.preview", "system.backups"),
    settings("system_templates.install", "system.backups"),
    settings("system_backups.catalog", "system.backups"),
    ...
    settings("system_backups.recovery.status", "system.backups"),
    settings("system_backups.verify", "system.backups"),
