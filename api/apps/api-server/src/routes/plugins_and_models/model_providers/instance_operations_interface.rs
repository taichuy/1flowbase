...
const DECLARATIONS: &[ConsoleInterfaceDeclaration] = &[
    ConsoleInterfaceDeclaration {
        interface_id: "model-providers.instances.authenticate",
    ...
    ConsoleInterfaceDeclaration {
        interface_id: "model-providers.instances.usage.view",
    ...
    ConsoleInterfaceDeclaration {
        interface_id: "model-providers.instances.reset-credits.view",
    ...
    ConsoleInterfaceDeclaration {
        interface_id: "model-providers.instances.reset-credits.consume",
    ...
    ConsoleInterfaceDeclaration {
        interface_id: "model-providers.balance.view",
    ...
    ConsoleInterfaceDeclaration {
        interface_id: "model-providers.preview.view",
    ...
    ConsoleInterfaceDeclaration {
        interface_id: "model-providers.instances.secrets.reveal",
