            ...
            mp::object_schema(&[
                ...
                (
                    ...
                    mp::object_schema(&[
                        ...
                        (
                            "entries",
                            serde_json::json!({"type":"array","maxItems":32,"items":mp::object_schema(&[("contract_version",serde_json::json!({"anyOf": [mp::text_schema(), {"type":"null"}]})), ("id",mp::text_schema()), ("catalog_id",mp::text_schema()), ("category",mp::object_schema(&[("byte_count",mp::count_schema())])), ("organization",mp::object_schema(&[("byte_count",mp::count_schema())])), ("artifact_id",mp::text_schema()), ("version",mp::text_schema()), ("node_id",mp::text_schema()), ("source_kind",mp::object_schema(&[("byte_count",mp::count_schema())])), ("trust_level",mp::object_schema(&[("byte_count",mp::count_schema())])), ("warnings",mp::object_schema(&[("item_count",mp::count_schema())])), ("expected_checksum",serde_json::json!({"anyOf": [mp::object_schema(&[("byte_count",mp::count_schema())]), {"type":"null"}]})), ("local_checksum",serde_json::json!({"anyOf": [mp::object_schema(&[("byte_count",mp::count_schema())]), {"type":"null"}]})), ("signature_status",mp::object_schema(&[("byte_count",mp::count_schema())])), ("signature_algorithm",serde_json::json!({"anyOf": [mp::object_schema(&[("byte_count",mp::count_schema())]), {"type":"null"}]})), ("signing_key_id",serde_json::json!({"anyOf": [mp::text_schema(), {"type":"null"}]})), ("status",mp::text_schema()), ("is_current",serde_json::json!({"type":"boolean"})), ("desired_state",serde_json::json!({"anyOf": [mp::object_schema(&[("byte_count",mp::count_schema())]), {"type":"null"}]})), ("availability_status",serde_json::json!({"anyOf": [mp::object_schema(&[("byte_count",mp::count_schema())]), {"type":"null"}]})), ("application_action",mp::object_schema(&[("byte_count",mp::count_schema())])), ("application_status",mp::object_schema(&[("byte_count",mp::count_schema())])), ("created_by",mp::object_schema(&[("byte_count",mp::count_schema())])), ("created_at",mp::text_schema()), ("updated_at",mp::text_schema()), ("installed_versions",mp::object_schema(&[("item_count",mp::count_schema())]))])}),
                        ),
                    ]),
                ),
            ]),
