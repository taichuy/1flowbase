...
pub(super) const TEXTS: &[CoreConsoleDisplayText] = &[
    ...
    policy!("Frontstage"),
    policy!("Registered Frontstage operations available to signed-in users"),
    policy!("Runtime localization catalog"),
    policy!("Registered runtime localization catalog operations available to signed-in users"),
